...
<body>
	...
	<div class="panel panel-default">
		<div class="panel-body">
			...
			<h2 class="lead">Busqueda</h2>

			<form:form commandName="ubicacionCmd" method="POST"
				action="buscarArticulo" class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-xs-10">
						<form:select path="region" class="form-control">
							<form:option value="" label="Elige una Region" />
				...
				<div class="form-group">
					<label for="comuna" class="control-label col-xs-2">Comuna</label>
					<div class="col-xs-10">
						<form:select path="comuna" class="form-control">
							<form:option value="" label="Elige una Comuna" />
				...
				<div class="form-group">
                    <label for="ciudad" class="control-label col-xs-2">Producto</label>
                    <div class="col-xs-10">
                        <form:input path="ciudad" type="text" class="form-control" id="inputCiudad" placeholder="Producto" required="true"/>
                    </div>
                </div>
			...
			<h2 class="lead">Geolocalizacion</h2>


			<div class="list-group" id="map" style="height: 500px"></div>
		</div>
	</div>
	<!-- /.container -->
					...
					.geocode(
							...
							function(results, status) {
								if (status === google.maps.GeocoderStatus.OK) {
									...
									infoWindow(marker, resultsMap, almacen[0],
											almacen[0], almacen[1]);
					...
					.addListener(
							...
							function() {
								var html = "<div><h3>"
										...
										+ "</h3><p>"
										+ marker.address
										+ "<br></div><a href='" + marker.url + "'>View location</a></p></div>";
