...
<div class="panel panel-default">
    <div class="panel-body">
        Datos Promocion
            ...
            <form:form id="verPromocionForm" commandName="promocionCmd" method="POST"  action="verPromocion" class="form-horizontal" >
            
            	<form:hidden  path="id.idpromocion" />
            	<form:hidden  path="id.almacenIdalmacen" />
		...
		Articulos Asociados a la  promocion
		</div>
    	<div class="panel-body">
    	...
    	<div class="panel-body">
        	...
        	<table id="tabla1" cellpadding='3' cellspacing='2' class="table table-filter tableWrap table-striped">
       			<c:forEach var="articulo" items="${articulos}">
						...
						<form:checkbox path="listaArticulos" name="${promocionCmd.listaArticulos}" value="${articulo.id.idarticulo}"  />
			...
			<td>
                            ...
                            <div>
                                <c:out value="Fecha Actualizacion ${fn:substring(articulo.fechaactualizacion,1,10)}" />
                            </div>
                        </td>			
