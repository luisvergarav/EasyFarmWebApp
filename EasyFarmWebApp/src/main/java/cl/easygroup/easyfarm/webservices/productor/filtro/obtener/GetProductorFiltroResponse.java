...
@XmlRootElement(name = "getProductorFiltroResponse")
public class GetProductorFiltroResponse {

    @XmlElement(required = true)
    protected GetProductorFiltroResponse.Productores productores;
     ...
     * @return
     *     possible object is
     *     {@link GetProductorFiltroResponse.Productores }
     *     
     */
    public GetProductorFiltroResponse.Productores getProductores() {
        return productores;
    }
     ...
     *     
     */
    public void setProductores(GetProductorFiltroResponse.Productores value) {
