...
<body>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-3" style="padding-left: 40px">
				<p class="">Ubicacion</p>
				<p class="">${almacen.ubicacion.calle}
					${almacen.ubicacion.numerocalle}</p>

				<div class="list-group" id="map" style="height: 200px"></div>
			</div>
	...
	<input
		value="${almacen.ubicacion.calle} ${almacen.ubicacion.numerocalle}"
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-9">
				...
				<p class="">${almacen.nombreAlmacen}</p>
				...
				<div class="row">
					<c:forEach var="promocion" items="${almacen.promocions}">
						<div class="col-sm-4 col-lg-4 col-md-4">
							<div class="thumbnail">
								<img
									src="http://freebies2deals.com/wp-content/uploads/2015/05/f2d78.png"
									alt="">
								<div class="caption">
