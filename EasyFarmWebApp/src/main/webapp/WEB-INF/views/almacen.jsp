    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3" style="padding-left: 40px" >	
                <p class="">Ubicacion</p>
                <p class="">${almacen.ubicacion.calle} ${almacen.ubicacion.numerocalle}</p>
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <h4><a href="<c:url value="verPromocion?idPromocion=${promocion.id.idpromocion}" />">${promocion.descripcion}</a>
                                </h4>                                
                            </div>
                            <div class="caption">
