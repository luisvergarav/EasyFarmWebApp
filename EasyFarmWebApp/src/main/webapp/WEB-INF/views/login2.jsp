...
<div class="container"> 
    <div  class=" pull-left" style="padding: 10px;">
        <h3 style="font-size: large;color: #ffffff"> EasyFarmWebApp </h3>
    </div>
	...
	<form name='f' action="<c:url value='j_spring_security_check' />"
		method='post'>
            ...
            <table class=" tableWrapSmall table-borderless">
				...
				<td colspan="2" style="padding-left: 10px"><input style="color: #000000" type='text' name='j_username' value=''/>
				</td>
			</tr>
			<tr style="border-left:solid 1px;color:#ffffff">
				<td style="padding-left: 10px"><p style="color: #ffffff">Contraseña:</p></td>
				<td colspan="2" style="padding-left: 10px"><input  style="color: #000000" type='password' name='j_password' />
				</td>
			</tr>
			<tr style="border-left: solid 1px;color:#ffffff">
